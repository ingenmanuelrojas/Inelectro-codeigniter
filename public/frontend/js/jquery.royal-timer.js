...
function RoyalCountdown() {
	...
	****************************/
	...
	this.bgColor = "#000", 				//Flip-element back color
	this.digitColor = "#fff", 				//Digits color on flip-elements
	this.textColor = "#333", 				//Text color under flip elements(seconds, minutes and etc.)
	...
	function TimerEnd() {
		...
		canvasContext.fillText("ERROR DE FECHA!", canvas.width/2, 90.5*param.elementSize);
	}
	...
	function DrawText() {
		canvasContext.fillStyle = textColor;
		canvasContext.font = 26*param.elementSize+"px Open Sans";
		canvasContext.textAlign = "center";
